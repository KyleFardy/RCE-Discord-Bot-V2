...
module.exports = {
    ...
    async execute(data, rce, client) {
        ...
        await send_team_join_log(client, member_name, owner_name, identifier, id, current_server);
...
async function send_team_join_log(client, member_name, owner_name, server_id, team_id, server) {
