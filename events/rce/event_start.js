    ...
    if (event_details) {
      ...
      try {
        ...
        await client.functions.send_embed(
          client,
          current_server.events_channel_id,
          `${data.server.identifier} - ${discord.title}`,
          discord.message,
          [],
          discord.image
        );
