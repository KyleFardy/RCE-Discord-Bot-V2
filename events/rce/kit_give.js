...
module.exports = {
  ...
  async execute(data, rce, client) {
    await client.functions.log(
      'info',
      `\x1b[38;5;208m[${data.server.identifier}]\x1b[0m \x1b[32;1m[KIT GIVEN]\x1b[0m ${data.admin} Has Given Kit \x1b[38;5;208m${data.kit}\x1b[0m To \x1b[38;5;208m${data.ign}\x1b[0m!`
    );
    ...
    await client.functions.send_embed(
      ...
      `${data.server.identifier} - Kit Given`,
      '',
      [
