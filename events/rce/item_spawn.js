...
module.exports = {
    ...
    async execute(data, rce, client) {
        ...
        const itemSpawnedMessage = `\x1b[38;5;208m[${data.server.identifier}]\x1b[0m \x1b[32;1m[ITEM SPAWNED]\x1b[0m ${data.ign} Was Given \x1b[38;5;208m${data.quantity}\x1b[0mx ${data.item}!`;
        ...
        if (process.env.ITEM_SPAWN_LOG === 'true' && !client.functions.is_empty(process.env.ITEM_SPAWN_CHANNEL)) {
            try {
                ...
                await client.functions.send_embed(client, process.env.ITEM_SPAWN_CHANNEL, "Item Spawned", "", [
