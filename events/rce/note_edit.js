...
module.exports = {
    ...
    async execute(data, rce, client) {
        ...
        if (is_blacklisted) {
            await handle_blacklisted_message(server.identifier, ign, new_message, client);
            return;
        }
...
async function log_new_message(server_id, ign, new_content, client) {
    await client.functions.log("info", `\x1b[38;5;208m[${server_id}]\x1b[0m \x1b[32;1m[NEW MESSAGE]\x1b[0m ${ign} Sent \x1b[38;5;208m${new_content}\x1b[0m!`);
}
