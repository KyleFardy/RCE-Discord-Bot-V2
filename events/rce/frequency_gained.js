...
async function log_frequency_received(
  client,
  server_id,
  frequency,
  coordinates,
  ...
  await client.functions.log(
    'info',
    `\x1b[38;5;208m[${server_id}]\x1b[0m \x1b[32;1m[FREQUENCY RECEIVED]\x1b[0m Frequency ${frequency}, Coordinates: ${coordinates}, Range: ${range}\x1b[0m`
  );
}
